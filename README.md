...
#> * Creating directory:
#>   /var/folders/vt/4sdxy0rd1b3b65nqssx … rrzaF7/githug-example-10664435ff6b0
...
#>   * max.txt
#> Commit:
#>   * [342ea8d] 2016-08-26: Brains'll only get you so far and luck always runs out.
```
...
#>   * jimmy.txt
#> Commit:
#>   * [e4f8716] 2016-08-26: That's the code word. I miss you, Peaches.
git_history()
#> # A tibble: 2 x 6
#>       sha                  message             when author
#>     <chr>                    <chr>            <chr>  <chr>
#> 1 e4f8716 That's the code word. I… 2016-08-26 14:44 louise
#> 2 342ea8d Brains'll only get you … 2016-08-26 14:44 louise
...
#>       sha                  message             when author
#>     <chr>                    <chr>            <chr>  <chr>
#> 1 342ea8d Brains'll only get you … 2016-08-26 14:44 louise
#> # ... with 2 more variables: email <chr>, commit <list>
```
