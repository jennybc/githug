...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/githug)](http://www.r-pkg.org/pkg/githug)
[![Travis-CI Build Status](https://travis-ci.org/jennybc/githug.svg?branch=master)](https://travis-ci.org/jennybc/githug)
[![codecov.io](https://codecov.io/github/jennybc/githug/coverage.svg?branch=master)](https://codecov.io/github/jennybc/githug?branch=master)
...
Forks. *to do*
  ...
  * __update fork based on fork origin!!!__
